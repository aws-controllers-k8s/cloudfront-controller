...
// +kubebuilder:rbac:groups=cloudfront.services.k8s.aws,resources=distributiontenants,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=cloudfront.services.k8s.aws,resources=distributiontenants/status,verbs=get;update;patch
