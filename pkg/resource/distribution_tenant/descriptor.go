...
const (
	FinalizerString = "finalizers.cloudfront.services.k8s.aws/DistributionTenant"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("distributiontenants")
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.DistributionTenant{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.DistributionTenant),
	}
}
