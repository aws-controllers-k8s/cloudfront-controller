...
// updateTagsInCreateRequest sets the tags on the CreateDistributionTenantInput
// from the resource's Spec.Tags. This is necessary because the code generator
// doesn't match the shape of the CRD spec to the CreateDistributionTenantInput.
func updateTagsInCreateRequest(resource *resource, input *svcsdk.CreateDistributionTenantInput) {
	input.Tags = nil
