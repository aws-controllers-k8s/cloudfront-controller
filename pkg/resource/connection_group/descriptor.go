...
const (
	FinalizerString = "finalizers.cloudfront.services.k8s.aws/ConnectionGroup"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("connectiongroups")
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.ConnectionGroup{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.ConnectionGroup),
	}
}
