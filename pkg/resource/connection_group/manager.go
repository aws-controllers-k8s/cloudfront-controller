...
// +kubebuilder:rbac:groups=cloudfront.services.k8s.aws,resources=connectiongroups,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=cloudfront.services.k8s.aws,resources=connectiongroups/status,verbs=get;update;patch
