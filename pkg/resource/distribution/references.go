...
func (rm *resourceManager) EnsureReferences(
	...
	if desiredKO.Spec.DistributionConfig != nil {
		if desiredKO.Spec.DistributionConfig.ViewerCertificate != nil {
			if desiredKO.Spec.DistributionConfig.ViewerCertificate.ACMCertificateRef != nil {
				if latestKO.Spec.DistributionConfig == nil {
					latestKO.Spec.DistributionConfig = &svcapitypes.DistributionConfig{}
				}
				if latestKO.Spec.DistributionConfig.ViewerCertificate == nil {
					latestKO.Spec.DistributionConfig.ViewerCertificate = &svcapitypes.ViewerCertificate{}
				}
				if latestKO.Spec.DistributionConfig.ViewerCertificate.ACMCertificateRef == nil {
					latestKO.Spec.DistributionConfig.ViewerCertificate.ACMCertificateRef = desiredKO.Spec.DistributionConfig.ViewerCertificate.ACMCertificateRef
				}
			}
		}
	}
