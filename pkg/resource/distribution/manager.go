...
// +kubebuilder:rbac:groups=cloudfront.services.k8s.aws,resources=distributions,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=cloudfront.services.k8s.aws,resources=distributions/status,verbs=get;update;patch
