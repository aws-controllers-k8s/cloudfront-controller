...
// +kubebuilder:rbac:groups=cloudfront.services.k8s.aws,resources=originrequestpolicies,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=cloudfront.services.k8s.aws,resources=originrequestpolicies/status,verbs=get;update;patch
